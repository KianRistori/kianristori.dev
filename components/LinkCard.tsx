...
export default function LinkCard(props: {icon: React.ReactElement, name: string, link: string}) {
  return (
    <a href={props.link}>
      <li className="flex h-14 transition-opacity justify-between font-medium rounded-lg text-sm px-3 py-2.5 text-center items-center bg-gray-800 text-white border border-gray-700">
