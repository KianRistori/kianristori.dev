		...
		<div className="grid w-full p-6 border rounded-lg shadow-md bg-transparent border-gray-700">
			...
			<div className="flex w-full self-end space-x-5">
				...
				{linkPage ? <a href={linkPage}>
					<button type="button" className="text-white bg-[#24292F] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center focus:ring-gray-500 hover:bg-[#050708]/30 ">
						Link
					</button>
				</a> : null }
			</div>
