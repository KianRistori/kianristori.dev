...
export default function LoginGitHub(props: {session: any, user: any}) {
  ...
  function noSession() {
    return (
        <button onClick={signInOauth} type="button" className="animate-in text-white bg-gray-800 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center mr-2 mb-2" style={{ "--index": 1 } as React.CSSProperties}>
