...
function PostCard({ title, description, image, github, slug }) {
  return (
    <div class="md:max-w-sm w-full bg-white rounded-lg border border-gray-200 shadow-2xl dark:bg-gray-800 dark:border-gray-700 ">
      <div class="flex justify-end w-full px-4 pt-8">
        <div class="flex flex-col w-full items-center pb-10">
            <img class="mb-3 w-24 h-24 shadow-lg object-cover" src={image} alt="Project Image"/>
